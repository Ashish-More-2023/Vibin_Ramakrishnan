...
function Hero() {
  ...
  return (
    <div className="min-w-full bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center lg:items-center justify-center py-8 md:py-8 lg:py-8 px-4 sm:px-6 md:px-12">
        ...
        <div className="w-full max-w-4xl flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16">
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left px-4 lg:px-0">
            ...
            {/* Name - Moderately Large */}
            <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl pb-4  text-transparent bg-gradient-to-r from-gray-800 to-slate-900 bg-clip-text">
              {heroData.name}
            </h1>
            
            {/* Designation & Departments */}
            <div className="py-3 flex flex-col sm:flex-row items-center justify-center lg:justify-start lg:items-stretch gap-3 sm:gap-4 ">
              <p className="text-sm sm:text-base font-semibold text-gray-600 uppercase tracking-wide self-center">
                ...
                <>
                  ...
                  <div className="flex flex-col gap-1">
                    {departmentsList.map((dept, idx) => (
                      <h3 key={idx} className="text-base md:text-lg font-semibold text-gray-800">
                        {dept}
                      </h3>
                    ))}
                  </div>
            ...
            {heroData.researchAreas && (
              <div className="mt-2 py-4 bg-gradient-to-r from-slate-100 to-gray-100 rounded-lg px-4 md:px-6 border border-slate-200">
                <p className="text-xs sm:text-sm md:text-base font-semibold text-gray-900 uppercase tracking-wide mb-2">
                  Research Areas
                </p>
